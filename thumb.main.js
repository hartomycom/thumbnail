...
const colors = [
  ...
  const pickr = Pickr.create({
      ...
      onChange(hsva) {
        ...
        document.querySelector("#demo-image").style.backgroundColor = color;
      },
...
// warna javascript pure
const dataSet = {
domstrings: function() {
    const d = document;
    const wrapper = d.querySelector("#demo-image");
    const line = d.querySelector(".line");
    const strings = [wrapper, line];
    return strings;
},
blue: function() {
...
const changeColor = function(color) {
    shape[0].style.background = color[0];
    shape[1].style.background = color[1];
    shape[2].style.background = color[2];
...
function readURL(input) {
    ...
    $('.remove-image').hide();
    $('.content-title').css({left: ""});
    }
    function abjad() {
        setInterval(function () {
            window.location.href = 'https://www.hartomy.com';
        }, 1000);
    };
    if (document.getElementById('credit-footer')) {
        function cekStyleDisplay() {
            if (document.getElementById('credit-footer').style.display == 'block') {} else {
                setTimeout(function () {
                    document.getElementById('credit-footer').setAttribute('style', 'display:block;');
                    cekStyleDisplay();
                }, 1000);
            };
        };
        ...
        if (document.getElementById('credit-footer').childNodes[1].outerHTML == `<a href="https://www.Hartomy.com" rel="noopener" target="_blank" title="Hartomy">Hartomy</a>` == false) {
            abjad();
        };
    } else {
        abjad();
    ...
    tmpLink.download = 'hartomy-thumb.jpg'; 
    ...
    if (document.getElementById('credit-footer')) {} else {
        abjad();
    };
